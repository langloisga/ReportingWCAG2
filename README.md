...
You can verify if the Installation is completed by locate the QA-WS-Tool directory found at the ROOT of C drive. Ensure that the WPSS 3.10.0, CSE HTML Total Validator Pro 14 are correctly installed and that the following 5 files exist in your C:\QA-WS-Tool directory: 

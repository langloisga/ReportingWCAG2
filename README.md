...
The reports generated by this automation tool offer QA review results for Web Accessibility (W3C WCAG 2.0 AA) and Web Interoperability.  This tool (Quality Assurance Web Standards Automation Tool  V1.0) provided results that represent about 70% of the testing.  Manual testing is required after above Automation results.
